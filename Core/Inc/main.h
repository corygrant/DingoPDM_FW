...
/* Private defines -----------------------------------------------------------*/
#define EXTRA1_Pin GPIO_PIN_13
#define EXTRA1_GPIO_Port GPIOC
#define EXTRA2_Pin GPIO_PIN_14
...
#define PF_IN8_Pin GPIO_PIN_3
#define PF_IN8_GPIO_Port GPIOA
#define PF_ST7_8_Pin GPIO_PIN_4
#define PF_ST7_8_GPIO_Port GPIOA
#define PF_IN7_Pin GPIO_PIN_5
#define PF_IN7_GPIO_Port GPIOA
#define PF_IN6_Pin GPIO_PIN_6
#define PF_IN6_GPIO_Port GPIOA
#define PF_ST5_6_Pin GPIO_PIN_7
#define PF_ST5_6_GPIO_Port GPIOA
#define PF_IN5_Pin GPIO_PIN_0
#define PF_IN5_GPIO_Port GPIOB
#define EXTRA3_Pin GPIO_PIN_1
#define EXTRA3_GPIO_Port GPIOB
#define DIG_IN1_Pin GPIO_PIN_10
#define DIG_IN1_GPIO_Port GPIOB
#define DIG_IN2_Pin GPIO_PIN_11
...
#define PF_DSEL3_4_Pin GPIO_PIN_11
#define PF_DSEL3_4_GPIO_Port GPIOA
#define PF_DEN3_4_Pin GPIO_PIN_12
#define PF_DEN3_4_GPIO_Port GPIOA
#define PF_IN3_Pin GPIO_PIN_15
#define PF_IN3_GPIO_Port GPIOA
#define PF_DEN2_Pin GPIO_PIN_4
#define PF_DEN2_GPIO_Port GPIOB
#define PF_IN2_Pin GPIO_PIN_5
